...
- (void)initData{
    ...
    self.selectColor = [UIColor colorWithHexString:@"#FF8000"];
    self.unSelectColor = [UIColor colorWithHexString:@"#333333"];
...
- (void)creatHeaderUI{
    ...
    for (int i = 0; i<self.headerTitleArray.count; i++) {
        ...
        [button setTitleColor:[UIColor colorWithHexString:@"#6D7D8D"] forState:UIControlStateNormal];
        [button setTitle:self.headerTitleArray[i] forState:UIControlStateSelected];
        [button setTitleColor:[UIColor colorWithHexString:@"#FFB808"] forState:UIControlStateSelected];
        ...
        line.backgroundColor = [UIColor colorWithHexString:@"#FFB808"];
